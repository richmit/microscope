...
*** Converting screenshots to gif                                  :noexport:

#+begin_src sh
rm toolsetbuttons_800.gif toolsetmenu_800.gif
convert toolsetbuttons.png -resize 800x toolsetbuttons_800.gif
convert toolsetmenu.png    -resize 800x toolsetmenu_800.gif

rm toolsetbutton-*.gif
convert toolsetbutton-capture.png  -resize 55x toolsetbutton-capture.gif
convert toolsetbutton-load.png     -resize 55x toolsetbutton-load.gif
convert toolsetbutton-scale.png    -resize 55x toolsetbutton-scale.gif
convert toolsetbutton-settings.png -resize 55x toolsetbutton-settings.gif

rm dialog-*.gif
convert dialog-setscale.png -resize 300x dialog-setscale.gif
convert dialog-settings.png -resize 300x dialog-settings.gif
#+end_src
...
ln -s ~/world/my_prog/ImageJ/PhiliaJ/PhiliaJ.ijm ~/Fiji.app/macros/toolsets/PhiliaJ.ijm
...
Button Functions:
 - file:toolsetbutton-capture.gif   :: Capture, ssave, and open an image from the camera.  Images are stored in the same location, and with the same file name conventions, used by =piSnap.sh=.
 - file:toolsetbutton-settings.gif  :: Change some configuration options 

#+ATTR_HTML: :align center
file:dialog-settings.gif

   - Turn on/off debugging
   - Turn on/off live preview before a capture
   ...
   - Set captured image scale (100% 0r 50%)
