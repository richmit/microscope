...
| / |        |             |       < |       |       |     > |     < |       |          |       |       |          |            > |         |
|   | 1/4"   | IMX219      |  3.6800 |  2.76 |  3280 |  2464 |   4.6 |    10 |      8.1 |  1.12 |  1.12 |  1.00163 |      0.99838 | IMX219  |
|   | 1/3.2" | IMX179      |  3.2880 | 2.512 |  3280 |  2464 |   4.1 |     8 |      8.1 |  1.00 |  1.02 |  0.98328 |      1.01700 | IMX179  |
|   | 1/2.5" | MT9P031     |  5.7000 |  4.28 |  2592 |  1944 |   7.1 |    24 |      5.0 |  2.20 |  2.20 |  0.99883 |      1.00117 | MT9P031 |
|   | 1/2.3" | Leica mc170 |  6.1000 |   4.6 |  2592 |  1944 |   7.6 |    28 |      5.0 |  2.35 |  2.37 |  0.99457 |      1.00546 | mc170   |
|   | 1/2.3" | Leica mc190 |  6.1000 |   4.6 |  3648 |  2736 |   7.6 |    28 |     10.0 |  1.67 |  1.68 |  0.99457 |      1.00546 | mc190   |
|   | 1/2.3" | IMX477 RPI  |  6.2868 | 4.712 |  4056 |  3040 |   7.9 |    29 |     12.3 |  1.55 |  1.55 |  1.00000 |      1.00000 | RPI     |
|   | 1/1.8" | IMX334      |  7.9000 |  4.64 |  3952 |  2320 |   9.2 |    36 |      9.2 |  2.00 |  2.00 |  0.99949 |      1.00051 | IMX334  |
|   | 2/3"   | IMX264      |  8.5000 |   7.1 |  2464 |  2056 |  11.1 |    60 |      5.1 |  3.45 |  3.45 |  0.99895 |      1.00105 | IMX264  |
|   | 16mm   | film        | 10.3000 |   7.4 |  4120 |  2960 |  12.7 |    76 |     12.2 |  2.50 |  2.50 |  1.00000 |      1.00000 | 16mm    |
|   | 1"     | IMX183      | 13.1300 |  8.76 |  5472 |  3648 |  15.8 |   115 |     20.0 |  2.40 |  2.40 |  0.99924 |      1.00076 | IMX183  |
|   | 1.1"   | IMX304      | 14.2000 |  10.4 |  4104 |  3006 |  17.6 |   147 |     12.3 |  3.46 |  3.46 |  1.00008 |      0.99992 | IMX304  |
|   | 4/3"   | OMD EM1 M2  | 17.4000 |    13 |  5184 |  3888 |  21.7 |   226 |     20.2 |  3.36 |  3.34 |  1.00385 |      0.99617 | OLY     |
|   | APS-C  | Nikon D3200 | 23.2000 |  15.4 |  6016 |  4000 |  27.8 |   357 |     24.1 |  3.86 |  3.85 |  1.00166 |      0.99834 | APSC    |
|   | 35mm   | film        | 36.0000 |  24.0 | 14400 |  9600 |  43.3 |   864 |    138.2 |  2.50 |  2.50 |  1.00000 |      1.00000 | 35mm    |
|   | 645    | film        | 56.0000 |  41.5 | 22400 | 16600 |  69.7 |  2324 |    371.8 |  2.50 |  2.50 |  1.00000 |      1.00000 | 645     |
|   | IMAX   | film        | 70.4000 |  52.6 | 28160 | 21040 |  87.9 |  3703 |    592.5 |  2.50 |  2.50 |  1.00000 |      1.00000 | IMAX    |
#+TBLFM: $8=sqrt($4*$4+$5*$5);%.1f
#+TBLFM: $9=$4*$5;%d
#+TBLFM: $10=$6*$7/1e6;%.1f
#+TBLFM: $11=1000*$4/$6;%.2f
#+TBLFM: $12=1000*$5/$7;%.2f
#+TBLFM: $13=$4*$7/$6/$5;%.5f
#+TBLFM: $14=$6*$5/$4/$7;%.5f
...
sudo reboot
#### Install packages
sudo apt install emacs gnuplot maxima sbcl telnet zsh tmux gitk paraview paraview-dev xterm imagemagick nomacs gimp ruby
...
mkdir -p synced/core/
mkdir -p synced/Doc2/gadgets/leicaS8APO/
...
date; echo back-pic-sync;        rsync -rlt --log-format=%f                            --modify-window=2                  --rsh='ssh' pi-cam.home.mitchr.me:tmp/pi-images/                             /c/Users/richmit/Pictures/pi-cam/;
...
date; echo leicaS8APO-docs;      rsync -rlt --log-format=%f --delete --delete-excluded --modify-window=2 --exclude '.git' --rsh='ssh' /c/Users/richmit/Documents/Doc2/gadgets/leicaS8APO/              pi-cam.home.mitchr.me:synced/Doc2/gadgets/leicaS8APO/;
date
#+end_src
