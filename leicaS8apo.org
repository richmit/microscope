...
date; echo back-pic-sync;        rsync -rlt --log-format=%f                            --modify-window=2                  --rsh='ssh' pi-cam.home.mitchr.me:Pictures/pi-cam0/                           /c/Users/richmit/Pictures/pi-cam/;
...
Button Functions:
 ...
 - file:toolsetbutton-settings.gif  :: Change some configuration options: 1) turn on/off debugging & 2) turn on/off live preview before a capture
