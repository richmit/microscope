...
** Auxiliary Len Magnification & Working Distance
:PROPERTIES:
:CUSTOM_ID: s4-aux-mag-wd
:END:

#+CAPTION: S4E -- Auxiliary Lens Magnification, and Working Distance 
#+ATTR_HTML: :border 2 solid #ccc :frame hsides :align center
| $A$              | $W$        | Perf |     Part |
|------------------+------------+------+----------|
...
** Auxiliary Len Magnification & Working Distance
:PROPERTIES:
:CUSTOM_ID: s8-aux-mag-wd
:END:

#+CAPTION: S8API -- Auxiliary Lens Magnification, and Working Distance 
#+ATTR_HTML: :border 2 solid #ccc :frame hsides :align center
| Leica Part # | $A$          | $W$    | Perf  |
|          <r> | <l>          | <r>    |  <c>  |
|--------------+--------------+--------+-------|
...
# APO
#+MACRO: ABX0 @@html:<div style='margin:0;padding:0.25em;color:black;background-color:lightgreen'>-</div>@@ 
#+MACRO: ABX1 @@html:<div style='margin:0;padding:0.25em;color:black;background-color:lightgreen'>&check;</div>@@ 
#+MACRO: ABXB @@html:<div style='margin:0;padding:0.25em;color:black;background-color:lightgreen'>&nbsp;</div>@@ 

# Acro
#+MACRO: CBX0 @@html:<div style='margin:0;padding:0.25em;color:black;background-color:yellow'>-</div>@@ 
#+MACRO: CBX1 @@html:<div style='margin:0;padding:0.25em;color:black;background-color:yellow'>&check;</div>@@ 
#+MACRO: CBXB @@html:<div style='margin:0;padding:0.25em;color:black;background-color:yellow'>&nbsp;</div>@@ 
...
# Check Mark
#+MACRO: CHK @@html:<div style='margin:0;padding:0.25em;color:black;background-color:white'>&check;</div>@@ 
...
| {{{NS2}}} $E_{MAG}$ {{{NS2}}} | {{{NS2}}} $A$ {{{NS8}}} | {{{SPP(003)}}} | {{{SPP(004)}}} | {{{SPP(005)}}} | {{{SPP(006)}}} | {{{SPP(008)}}} | {{{SPP(010)}}} | {{{SPP(013)}}} | {{{SPP(016)}}} | {{{SPP(020)}}} | {{{SPP(026)}}} | {{{SPP(032)}}} | {{{SPP(040)}}} | {{{SPP(050)}}} | {{{SPP(064)}}} | {{{SPP(080)}}} | {{{SPP(100)}}} | {{{SPP(128)}}} | {{{SPP(160)}}} | {{{SPP(200)}}} | {{{SPP(256)}}} | {{{SPP(320)}}} | {{{SPP(400)}}} | {{{SPP(500)}}} | {{{SPP(640)}}} |
| <l>                           | <l>                     |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |
|-------------------------------+-------------------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------|
| {{{NS2}}} $10\times$          | {{{NS2}}} $0.50\times$  |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |
| {{{NS2}}} $10\times$          | {{{NS2}}} $0.75\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |
| {{{NS2}}} $16\times$          | {{{NS2}}} $0.50\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |
| {{{NS2}}} $10\times$          | {{{NS2}}} $1.00\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |
| {{{NS2}}} $25\times$          | {{{NS2}}} $0.50\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |
| {{{NS2}}} $10\times$          | {{{NS2}}} $1.60\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |
| {{{NS2}}} $20\times$          | {{{NS2}}} $1.00\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |
| {{{NS2}}} $10\times$          | {{{NS2}}} $2.00\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |
| {{{NS2}}} $16\times$          | {{{NS2}}} $1.60\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |
| {{{NS2}}} $20\times$          | {{{NS2}}} $1.60\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |
| {{{NS2}}} $25\times$          | {{{NS2}}} $1.60\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |
| {{{NS2}}} $40\times$          | {{{NS2}}} $1.60\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |
| {{{NS2}}} $40\times$          | {{{NS2}}} $2.00\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{CBX0}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |
#+HTML: </div>
...
#+ATTR_HTML: :rules all solid #ccc :frame all :align center :cellpadding 0 :border-spacing 0
| {{{NS2}}} $E_{MAG}$ {{{NS2}}} | {{{NS2}}} $A$ {{{NS8}}} | {{{SPP(003)}}} | {{{SPP(004)}}} | {{{SPP(005)}}} | {{{SPP(006)}}} | {{{SPP(008)}}} | {{{SPP(010)}}} | {{{SPP(013)}}} | {{{SPP(016)}}} | {{{SPP(020)}}} | {{{SPP(026)}}} | {{{SPP(032)}}} | {{{SPP(040)}}} | {{{SPP(050)}}} | {{{SPP(064)}}} | {{{SPP(080)}}} | {{{SPP(100)}}} | {{{SPP(128)}}} | {{{SPP(160)}}} | {{{SPP(200)}}} | {{{SPP(256)}}} | {{{SPP(320)}}} | {{{SPP(400)}}} | {{{SPP(500)}}} | {{{SPP(640)}}} |
| <l>                           |           <l>           |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |      <c>       |                |
|-------------------------------+-------------------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------|
| {{{NS2}}} $10\times$          | {{{NS2}}} $0.32\times$  |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{CBX1}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    | {{{XBX}}}      |
| {{{NS2}}} $10\times$          | {{{NS2}}} $0.63\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    | {{{XBX}}}      |
| {{{NS2}}} $10\times$          | {{{NS2}}} $1.00\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    | {{{XBX}}}      |
| {{{NS2}}} $20\times$          | {{{NS2}}} $0.63\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    | {{{XBX}}}      |
| {{{NS2}}} $16\times$          | {{{NS2}}} $1.00\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    | {{{XBX}}}      |
| {{{NS2}}} $10\times$          | {{{NS2}}} $2.00\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{ABX1}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    | {{{XBX}}}      |
| {{{NS2}}} $25\times$          | {{{NS2}}} $1.00\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    | {{{XBX}}}      |
| {{{NS2}}} $16\times$          | {{{NS2}}} $2.00\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    | {{{XBX}}}      |
| {{{NS2}}} $40\times$          | {{{NS2}}} $1.00\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{XBX}}}    |   {{{XBX}}}    | {{{XBX}}}      |
| {{{NS2}}} $25\times$          | {{{NS2}}} $2.00\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{XBX}}}    | {{{XBX}}}      |
| {{{NS2}}} $40\times$          | {{{NS2}}} $2.00\times$  |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{XBX}}}    |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   |   {{{ABX0}}}   | {{{ABX0}}}     |
#+HTML: </div>
...
| {{{CHK}}} | I  have this combination of equipment      |
...
Note: I originally built this camera around 2021, so the hardware listed below is pretty old (Pi model 4).  The good news is that the software components
described later work on newer Raspberry PIs, so you should be able to make a version of this project with modern hardware without too much difficulty.
...
| [[https://www.adafruit.com/product/4340][Heatsink Raspberry Pi 4 Case with Dual Fans]] ([[#rpi-camera-case-fan][NOTE]])    |           26 |
...
I like to be able to move the microscope around on my desk, so I have the whole thing on Teflon glider feet.  This makes wire management a bit tricky.  The
power cable I purchased is quite sturdy and has a large EMI filter choke that's about the 10mm in diameter.  I decided to use this as my primary cable mount
point by clamping the choke into a small camera rig pipe mount which I connected to the 1/4" photographic mounting hole on the camera ring.  I then routed all
the wires parallel to the power cable, and encased them in a wire tube.  I also added a couple zip-ties to secure the wire tube to the camera plate.  The whole
thing is pretty resilient.

#+ATTR_HTML: :border 2 solid #ccc :frame hsides :align center
[[file:20251211_135029.jpg][file:20251211_135029_200.jpg]]
#+ATTR_HTML: :border 2 solid #ccc :frame hsides :align center
[[file:20251211_135035.jpg][file:20251211_135035_200.jpg]]
#+ATTR_HTML: :border 2 solid #ccc :frame hsides :align center
[[file:20251211_135050.jpg][file:20251211_135050_200.jpg]]

** Wired Ethernet vs. WiFi

It's more than reasonable to use WiFi for this setup; however, things like software updates are a little slow.  In the end I decided to use this super thin
Ethernet cable I had in the cable box.  Honestly if I hadn't had that cable laying around I probably would have stuck with WiFi.

** Cooling Fan & Heat Sink Case
:PROPERTIES:
:CUSTOM_ID: rpi-camera-case-fan
:END:


The fan is pretty unnecessary in my experience, and I generally keep it disconnected.  The Pi can display a streaming view from the camera for hours without
the temperature ever going over 50C in my lab (I keep the lab at about 20C).
...
First the Raspberry Pi must be configured -- the OS installed & configured.  The best place to start with that is probably the
[[https://www.raspberrypi.com/documentation/computers/getting-started.html][official "getting started" documentation]].

The instructions below describe the next step of installing and configuring the camera related software.  Note the following instructions are for the Debian
Trixie (version 13) based Raspberry Pi OS released in October of 2025.
...
The following steps should work for most people out of the box.  The only tricky bit is Fiji because it is such a dynamic project, and things change over
time.
...
Most Unix/Linux users have pretty strong opinions on how to setup a personal working environment.  This section documents my personal configuration.  I
preform these steps *before* I do the stuff in the section [[#rpi-camera-min-soft-config][Minimal Configuration]].

  - I have a bunch of stuff in my home directory I sync (via [[#rpi-camera-my-soft-sync][rsync]]) from my primary workstation.
...
**** System Sync
:PROPERTIES:
:CUSTOM_ID: rpi-camera-my-soft-sync
:END:

I frequently sync my primary workstation with the =pi-cam=. The sync is bidirectional pulling data from the RPI (captured images & data) to my workstation,
and to the RPI (scripts & config).  I sync over the network using =rsync= via =ssh=. The commands below are executed on my primary workstation.  
...
exposes the microscope functionality.  That is to say, the only difference between "=RPI_tools=" and "=PhilaJ=" is the ImageJ/Fiji toolset code the exposes
the functionality to the end user.  Full documentation may be found here:
